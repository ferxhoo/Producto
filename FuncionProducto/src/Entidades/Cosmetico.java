...
public class Cosmetico extends Producto{
    ...
    public Cosmetico(LocalDate fechaDeCaducidad, String referencia, String descripcion, String estado, String categoria) {
  ...
  /* 
    ...
    public String infoProducto(){
        return String.format("%-20s: %s\n", 
                             "Fecha de Vencimiento", this.fechaDeCaducidad.toString()); 
    }
   */ 
}
