        ...
        while(op == true){
            ...
            switch (categoria) {
                case 'A' -> {
                    ...
                    nuevoProducto = new Accesorio(detalle, referencia, descripcion, estado, categoriaP);
                }
                default -> {
                    ...
                    nuevoProducto = new Cosmetico(fechaDeCaducidad, referencia, descripcion, estado, categoriaP);
                }
            }
